...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('backend/asset/images/icon/favicon.ico')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/metisMenu.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/slicknav.min.css')}}">
    <!-- amchart css -->
    <link rel="stylesheet" href="https://www.amcharts.com/lib/3/plugins/export/export.css" type="text/css" media="all" />
    <!-- others css -->
    <link rel="stylesheet" href="{{asset('backend/asset/css/typography.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/default-css.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/styles.css')}}">
    <link rel="stylesheet" href="{{asset('backend/asset/css/responsive.css')}}">
    <!-- modernizr css -->
    <script src="{{asset('backend/asset/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('backend/asset/images/icon/logo.png')}}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                                    ...
                                    <div class="nofity-list">
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('backend/asset/images/author/author-img1.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('backend/asset/images/author/author-img2.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('backend/asset/images/author/author-img3.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="{{asset('backend/asset/images/author/author-img4.jpg')}}" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="{{asset('backend/asset/images/author/avatar.png')}}" alt="avatar">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                <td class="mv-icon"><img src="{{asset('backend/asset/images/icon/market-value/icon1.png')}}" alt="icon">
                                                </td>
                                                <td class="coin-name">Dashcoin</td>
                                                <td class="buy">30% <img src="{{asset('backend/asset/images/icon/market-value/triangle-down.png')}}" alt="icon"></td>
                                                <td class="sell">20% <img src="{{asset('backend/asset/images/icon/market-value/triangle-up.png')}}" alt="icon"></td>
                                                <td class="trends"><img src="{{asset('backend/asset/images/icon/market-value/trends-up-icon.png')}}" alt="icon"></td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="{{asset('backend/asset/images/icon/market-value/icon2.png')}}" alt="icon"></div>
                                                </td>
                                                <td class="coin-name">LiteCoin</td>
                                                <td class="buy">30% <img src="{{asset('backend/asset/images/icon/market-value/triangle-down.png')}}" alt="icon"></td>
                                                <td class="sell">20% <img src="{{asset('backend/asset/images/icon/market-value/triangle-up.png')}}" alt="icon"></td>
                                                <td class="trends"><img src="{{asset('backend/asset/images/icon/market-value/trends-down-icon.png')}}" alt="icon"></td>
                                                <td class="attachments">$ 56746,857</td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="{{asset('backend/asset/images/icon/market-value/icon3.png')}}" alt="icon"></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="{{asset('backend/asset/images/icon/market-value/icon4.png')}}" alt="icon"></div>
                                                </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="letest-news mt-5">
                                    <div class="single-post mb-xs-40 mb-sm-40">
                                        <div class="lts-thumb">
                                            <img src="{{asset('backend/asset/images/blog/post-thumb1.jpg')}}" alt="post thumb">
                                        </div>
                                    ...
                                    <div class="single-post">
                                        <div class="lts-thumb">
                                            <img src="{{asset('backend/asset/images/blog/post-thumb2.jpg')}}" alt="post thumb">
                                        </div>
                                        <div class="lts-content">
                                            <span>Admin Post</span>
                                            <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
    ...
    <script src="{{asset('backend/asset/js/vendor/jquery-2.2.4.min.js')}}"></script>
    <!-- bootstrap 4 js -->
    ...
    <script src="{{asset('backend/asset/js/metisMenu.min.js')}}"></script>
    <script src="{{asset('backend/asset/js/jquery.slimscroll.min.js')}}"></script>
    <script src="{{asset('backend/asset/js/jquery.slicknav.min.js')}}"></script>
    ...
    <script src="{{asset('backend/asset/js/line-chart.js')}}"></script>
    <!-- all pie chart -->
    <script src="{{asset('backend/asset/js/pie-chart.js')}}"></script>
    <!-- others plugins -->
